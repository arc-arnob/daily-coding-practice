...
So when promiseAll(which is just a wrapper function) is invoked, 
out of the four promises, promise4 rejects with value 4 . So the result is no longer available, and an error is thrown which gets captured in the catch and logs 4 to the console.
 */